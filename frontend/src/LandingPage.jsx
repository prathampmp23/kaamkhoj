        ...
        <>
          ...
          <main>
            ...
            <section className="quick-actions">
              <div className="container">
                <div className="action-card">
                  ...
                  <button className="action-btn">{content[language].quickActions.findJob.button}</button>
                </div>
                ...
                <div className="action-card highlight">
                  ...
                  <button className="action-btn">{content[language].quickActions.voiceForm.button}</button>
                </div>
                ...
                <div className="action-card">
                  ...
                  <button className="action-btn">{content[language].quickActions.contact.button}</button>
                </div>
              </div>
            </section>
            ...
            <section className="features-section">
              <div className="container">
                <h2 className="section-title">{content[language].features.title}</h2>
                <div className="features-grid">
                  {content[language].features.list.map((feature, index) => (
                    <div className="feature" key={index}>
                      <div className="feature-icon">
                        <i className={`fas fa-${['language', 'volume-up', 'map-marker-alt', 'user-shield'][index]}`}></i>
                      </div>
                      <h3>{feature.title}</h3>
            ...
            <JobListings title={content[language].jobListings} showCount={4} language={language} />
            
            <section className="cta-section">
              <div className="container">
                <h2>{content[language].cta.title}</h2>
                <p>{content[language].cta.description}</p>
                <button className="cta-button">{content[language].cta.button}</button>
              </div>
            </section>
            
            <AiAssistant language={language} />
            
            <AiAssistant preview={true} />
          </main>
