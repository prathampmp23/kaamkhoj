      ...
      <div className="container">
            ...
            <div className="job-card" key={job.id}>
              ...
              <div className="job-details">
                ...
                <div className="job-location">
                  <i className="fas fa-map-marker-alt"></i> {job.location[language]}
                </div>
              </div>
              <button className="job-apply-btn">{translations[language].applyNow}</button>
            </div>
          ))}
        </div>
        ...
        <div className="view-all-container">
          <button className="view-all-btn">
            {translations[language].viewAll} <i className="fas fa-arrow-right"></i>
          </button>
        </div>
      </div>
    </section>
